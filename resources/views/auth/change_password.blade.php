...
@section('title', 'Akun Saya - RTSmart')
            ...
            <div class="card">
              <div class="card-body pt-3">
               ...
               <form action="{{route('setting.update',1)}}" method="POST" enctype="multipart/form-data">
                @csrf @method('put')
                <div class="row mb-3">
                  <label for="logo" class="col-md-4 col-lg-3 col-form-label">Foto Profil</label>
                  <div class="col-md-8 col-lg-9">
                    @if ($user->photo)
                    <img src="{{$user->photo}}" alt="Foto Profil" height="100" class="rounded-circle">
                    @else
                    <img src="assets/img/blank-profile.png" alt="Foto Profil" height="100" class="rounded-circle">
                    @endif
                    <div class="pt-2">
                ...
                <div class="row mb-3">
                  <label for="old_password" class="col-md-4 col-lg-3 col-form-label">Kabupataen/Kota</label>
                  <div class="col-md-8 col-lg-9">
